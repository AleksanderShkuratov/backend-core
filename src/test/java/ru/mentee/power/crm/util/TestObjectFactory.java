...
public class TestObjectFactory {
  ...
  public static final String DEFAULT_CITY = "Klin";
  public static final String DEFAULT_STREET = "Lenina";
  public static final String DEFAULT_ZIP = "141601";
  public static final String DEFAULT_EMAIL = "test@example.com";
  public static final String DEFAULT_PHONE = "+71234567890";
